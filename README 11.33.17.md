...
### Runtime by Movie
A horizontal bar chart ranking all films by runtime in descending order. *12 Years a Slave* leads at approximately 140 minutes, while *The Artist* is the shortest in the dataset.
